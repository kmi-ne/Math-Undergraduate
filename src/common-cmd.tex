...
% 環境
\ExplSyntaxOn
\tl_new:N \g_my_OutsideEq_tl
\tl_gset:Nn \g_my_OutsideEq_tl { T }
\tl_new:N \g_my_EqType_tl
\NewDocumentCommand { \? } { O{} } {
  \tl_if_eq:NnTF \g_my_OutsideEq_tl { T } {
    \tl_if_empty:nTF { #1 } {
      \hfill$\begin{aligned}[t]
      \tl_gset:Nn \g_my_EqType_tl { at }
    } {
      \tl_if_eq:nnTF { #1 } { a } {
        \[\begin{aligned}
    ...
    \tl_gset:Nn \g_my_OutsideEq_tl { F }
  } {
    \tl_if_eq:NnTF \g_my_EqType_tl { at } {
      \end{aligned}$\hfill\null
    } {}
