...
\newcommand{\separator}{\begin{center}◇\qquad ◇\qquad ◇\end{center}}
...
\setlist[myenum, 1]{label=(\roman{myenumi}), ref=(\roman{myenumi}), leftmargin=*}
\setlist[myenum, 2]{label=(\roman{myenumi}.\roman{myenumii}), ref=(\roman{myenumi}.\roman{myenumii}), leftmargin=*}
\setlist[myenum, 3]{label=(\roman{myenumi}.\roman{myenumii}.\roman{myenumiii}), ref=(\roman{myenumi}.\roman{myenumii}.\roman{myenumiii}), leftmargin=*}
\newlist{myenum*}{enumerate*}{1}
\setlist[myenum*]{label=(\roman*), ref=(\roman*)}
% - - - - - - - - - -
\newlist{thmlist}{enumerate}{3}
\setlist[thmlist, 1]{label=\arabic{thmlisti}., ref=\arabic{thmlisti}, leftmargin=*}
...
\setlist[step, 1]{label=(\arabic{stepi}), ref=(\arabic{stepi}), leftmargin=*}
\setlist[step, 2]{label=(\arabic{stepi}.\arabic{stepii}), ref=(\arabic{stepi}.\arabic{stepii}), leftmargin=*}
\setlist[step, 3]{label=(\arabic{stepi}.\arabic{stepii}.\arabic{stepiii}), ref=(\arabic{stepi}.\arabic{stepii}.\arabic{stepiii}), leftmargin=*}
% - - - - - - - - - -
